...
class CollegeFour extends Component {
	constructor(props) {
		// code
		super(props);
		this.state={
	...
	componentWillMount(){
		collegeCourse('college_four').then((data)=>{
			...
			<div>
				<div className='tab_wrap'>
				    <div className='tab'>
				    	...
				    	<a href='#/collegeFour' className='tab_a'>大四课程 <span className='triangle'></span></a>
				    </div>
