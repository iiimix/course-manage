...
class CollegeTwo extends Component {
	constructor(props) {
		// code
		super(props);
		this.state={
	...
	componentWillMount(){
		collegeCourse('college_two').then((data)=>{
			...
			<div >
				<div className='tab_wrap'>
				    <div className='tab'>
				    	...
				    	<a href='#/collegeTwo' className='tab_a'>大二课程<span className='triangle'></span></a>
